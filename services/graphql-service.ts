import {GQLQueryDataCallback} from '../../prendus-question-elements/prendus-question-elements.d';
import {GQLQueryErrorCallback} from '../../prendus-question-elements/prendus-question-elements.d';
import {GQLSubscribeCallback} from '../../prendus-question-elements/prendus-question-elements.d';
import {GQLMutateErrorCallback} from '../../prendus-question-elements/prendus-question-elements.d';
import {getGraphcoolHTTPEndpoint, getGraphcoolWebSocketEndpoint} from './utilities-service';
...
export const GQLRequest = async (queryString: string, variables: { [key: string]: any }, userToken: string | null, errorCallback: GQLQueryErrorCallback) => {
